...
public class SpringlessFastByteArrayOutputStream extends OutputStream {
    ...
    public SpringlessFastByteArrayOutputStream() {
        this(256);
    }

    public SpringlessFastByteArrayOutputStream(int initialBlockSize) {
    ...
    public FastByteArrayInputStream getInputStream() {
        return new SpringlessFastByteArrayOutputStream.FastByteArrayInputStream(this);
    }
    ...
    private static final class FastByteArrayInputStream extends SpringlessUpdateMessageDigestInputStream {
        ...
        public FastByteArrayInputStream(SpringlessFastByteArrayOutputStream fastByteArrayOutputStream) {
